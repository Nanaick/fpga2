...
HD_PWD='G:/QH_WORK/Demo/vivado_prj/demo_rb_64/demo_rb_64/demo_rb_64.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_RB.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TOP_RB.tcl
