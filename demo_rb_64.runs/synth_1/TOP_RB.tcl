...
set_property used_in_implementation false [get_files G:/QH_WORK/Demo/vivado_prj/demo_rb_64/demo_rb_64/demo_rb_64.srcs/constrs_1/new/TOP_PIN.xdc]
...
synth_design -top TOP_RB -part xc7z100ffg900-2


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef TOP_RB.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file TOP_RB_utilization_synth.rpt -pb TOP_RB_utilization_synth.pb"
