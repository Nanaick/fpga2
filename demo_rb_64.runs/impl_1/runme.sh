...
HD_PWD='G:/QH_WORK/Demo/vivado_prj/demo_rb_64/demo_rb_64/demo_rb_64.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_RB.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TOP_RB.tcl -notrace
